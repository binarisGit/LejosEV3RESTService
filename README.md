...
1.  download [lejos.zip](https://bitbucket.org/Cappin79/lejosrestapi/downloads) and move the contained unzipped directory to your local maven repository (e.g. C:\Users\Christian.Asus-F550LC\\.m2\repository\lejos). Do not forget to update your maven afterwards!
